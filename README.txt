...
Файлы в этом архиве распостраняются по лицензии GNU GPL.
Вы можете найти копию этой лицензии в файле LICENSE.txt.
...
- Добавлена поддержка плагина Page и динамическая генерация sitemap для страниц.
- Добавлена поддержка плагина Gallery и динамическая генерация sitemap для
  альбомов, изображений альбомов, категорий, изображений категорий и тегов.
