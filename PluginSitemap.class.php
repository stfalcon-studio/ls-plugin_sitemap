...
class PluginSitemap extends Plugin {
    ...
    protected $aInherits = array(
        'entity' => array(
            'ModuleBlog_EntityBlog' => 'PluginSitemap_Blog_EntityBlog',
            'ModuleTopic_EntityTopic' => 'PluginSitemap_Topic_EntityTopic',
            'ModuleUser_EntityUser' => 'PluginSitemap_User_EntityUser',
        ),
    );
